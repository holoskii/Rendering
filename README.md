...
![](output/simple_shapes.bmp?raw=true)
...
|:----------------:|:----------------:|:----------------:|:----------------:|
|![](output/phong_ambient.bmp?raw=true)|![](output/phong_diffuse.bmp?raw=true)|![](output/phong_specular.bmp?raw=true)|![](output/phong_final.bmp?raw=true)|
...
![](output/reflective_refractive.bmp?raw=true)
...
|:----------------:|:----------------:|
|![](output/backface_culling_on.bmp?raw=true)|![](output/backface_culling_off.bmp?raw=true)|
...
|:----------------:|:----------------:|:----------------:|
|![](output/acceleration_struct_object.bmp?raw=true)|![](output/acceleration_struct_low.bmp?raw=true)|![](output/acceleration_struct_high.bmp?raw=true)|
...
|:----------------:|:----------------:|
|![](output/basic_shader_off.bmp?raw=true)|![](output/basic_shader_on.bmp?raw=true)|
...
|:----------------:|:----------------:|:----------------:|
|![](input/objects/cow_diffuse.bmp?raw=true)|![](output/cow_undextured.bmp?raw=true)|![](output/cow_textured.bmp?raw=true)| 
...
![](output/shotgun_normal.bmp?raw=true)
![](output/shotgun_normal_map.bmp?raw=true)
...
![](output/shotgun_specular.bmp?raw=true)

All 3 maps of the following model:
| Texture (diffuse) map | Normal map | Specular map |
|:----------------:|:----------------:|:----------------:|
|![](input/objects/shotgun_diffuse.bmp?raw=true)|![](input/objects/shotgun_normal.bmp?raw=true)|![](input/objects/shotgun_specular.bmp?raw=true)| 
  
And with those 3 image we managed to enhance view of our model without significant performance loss.
![](output/shotgun_basic.bmp?raw=true)
![](output/shotgun.bmp?raw=true)
...
|:----------------:|:----------------:|
|![](output/area_light_none.bmp?raw=true)|![](output/area_low_res.bmp?raw=true)|
| Small light source | Large light source |
|![](output/area_small.bmp?raw=true)|![](output/area_large.bmp?raw=true)|
